...
const handleSubmit = (values, { setSubmitting, setStatus }) => {
 ...
 const onSubmit = async (values, setStatus) => {
    const { email, password, university_id, name, phone_number, department } = values;
        const user = {
            email,
            password,
            university_id,
    ...
    {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting, status }) => (
      <Form noValidate onSubmit={handleSubmit}>
        ...
        <Form.Group controlId="department">
            ...
            <Form.Control as="select" name="department" value={values.department} onChange={handleChange} onBlur={handleBlur} isInvalid={touched.department && !!errors.department}>
