...
export const AddPositions = () => {
  ...
  const handleOptionChange = (newOption) => { setLevel(newOption); };
  const handleTextAreaChange = (newText) => { setDescription(newText); };
  ...
  const validateForm = () => {
    ...
    if (office === null)
        selectOfficeLabel.classList.add('error');
    else
        selectOfficeLabel.classList.remove('error');
    
    if (level === null)
        selectLevelLabel.classList.add('error');
    else
        selectLevelLabel.classList.remove('error');
    
    if (position === null)
        selectPositionLabel.classList.add('error');
    else
        selectPositionLabel.classList.remove('error');
  ...
  return (
    ...
    <Form.Group controlId="selectOffice">
      <Form.Label className='selectOfficeError'><h5>Select an Office *</h5></Form.Label>
      ...
      <Form.Group controlId="selectLevel">
        <Form.Label className='selectLevelError'><h5>Select a Level *</h5></Form.Label>
        <RadioButton
          options={levels}
      ...
      <Form.Group controlId="selectPosition">
        <Form.Label className='selectPositionError'><h5>Select a Position *</h5></Form.Label>
